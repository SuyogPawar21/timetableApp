...
#ifndef TIMETABLE_MANAGER_SWIFT_H
#define TIMETABLE_MANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="timetable_manager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17timetable_manager11AppDelegate")
...
SWIFT_CLASS("_TtC17timetable_manager17MainFlutterWindow")
